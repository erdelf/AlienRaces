...
re
        ...
        public static bool ResolveAllGraphicsPrefix(PawnGraphicSet __instance)
        {
            ...
            if (alien.def is ThingDef_AlienRace alienProps)
            {
                ...
                __instance.hairGraphic = GraphicDatabase.Get<Graphic_Multi>(__instance.pawn.story.hairDef.texPath, ContentFinder<Texture2D>.Get(__instance.pawn.story.hairDef.texPath + "_backm") == null ? ShaderDatabase.Cutout : ShaderDatabase.CutoutComplex, Vector2.one, alien.story.hairColor, alien.story.hairColor);
...
/*      just keeping it here in case I need it at some point
